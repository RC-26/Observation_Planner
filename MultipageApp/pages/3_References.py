...
st.markdown ("This Streamlit app was developed by **Arcy Layne L. Sace**<sup>1</sup>, **Darren Mykel V. Gapay**<sup>2</sup>, **Ernest P. Macalalad**<sup>1</sup>, and **Reinabelle C. Reyes**<sup>1,3</sup>", unsafe_allow_html = True)
